 ...
 *
 */
void encrypt_present_rounds(unsigned char *in, unsigned char *out, unsigned char *skey, int rounds);

//#define uint8_t char

// full-round PRESENT block cipher
#define encrypt_present_8(plain, cipher, key) encrypt_present_rounds((plain), (cipher), (key), 31)

// actually is (sbox[] << 4)
static const uint8_t sbox[16] PROGMEM = {
...
static const uint8_t sbox_pmt_3[256] PROGMEM = {
...
static const uint8_t sbox_pmt_2[256] PROGMEM = {
...
static const uint8_t sbox_pmt_1[256] PROGMEM = {
...
static const uint8_t sbox_pmt_0[256] PROGMEM = {
